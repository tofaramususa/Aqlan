...
from chatModels.chatGroqModel import llm_json_mode, llm
from generateRag import format_docs, rag_prompt
from retrieverGrader import doc_grader_instructions, doc_grader_prompt
from webSearch import web_search_tool
from router import router_instructions
from hallucinationGrader import hallucination_grader_instructions, hallucination_grader_prompt
...
def route_question(state):
    ...
    source = json.loads(json.dumps(route_question))["datasource"]
    if source == "websearch":
